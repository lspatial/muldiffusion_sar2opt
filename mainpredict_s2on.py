...
def configArgs():
    ...
    parser.add_argument('--map_swinunet', type=str,
                        default='/devb/sar2opt_diff/mapping_test2/model_statedict_best.tor',
                        help='Trained SWIN-Unet file: default: no trained UNet')
    ...
    parser.add_argument('--condition_way', type=str,
                        default='SARMAP',
                        help='condition way:{SAR, SARMAP, SARMAPTXT,SARTXT} default: SAR')
    ...
    parser.add_argument('--in_channels', type=int,
                        default=3,
                        help='dimension number of input (RGB) plus conditionals (SAR or SAR + mapping): default: 4')
...
def main():
    ...
    predict_loader, _ = create_dataloaders(args.data_path, channels=3,
                                           ...
                                           val_split=0, subset_size=args.subset, resize_to=None, crop_size=None,
                                           label2text=False)
